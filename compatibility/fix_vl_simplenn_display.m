function info = fix_vl_simplenn_display(net, varargin)
...
elseif isfield(net, 'normalization') && isfield(net.normalization, 'imageSize')
    if size(net.normalization.imageSize, 2) == 3
       info.dataSize(1:4, 1) = [net.normalization.imageSize(:); opts.batchSize];
    elseif  size(net.normalization.imageSize, 2) == 4
       info.dataSize = net.normalization.imageSize';
       info.dataSize(4) = opts.batchSize;
    end
else
